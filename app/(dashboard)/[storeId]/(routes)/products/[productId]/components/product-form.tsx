...
export function ProductForm({
  ...
  const title: "Edit product" | "Create product" = initialData
    ? "Edit product"
    : "Create product";
  const description: "Edit a product." | "Add a new product" = initialData
    ? "Edit a product."
    : "Add a new product";
  const toastMessage: "Product updated." | "Product created." = initialData
    ? "Product updated."
    : "Product created.";
  ...
  const onSubmit: (data: ProductFormValues) => Promise<void> = async (
